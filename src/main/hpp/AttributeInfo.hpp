...
class CodeAttribute
{
  public:
    ...
    CodeAttribute read(FILE*, AttributeInfo);
};
...
class InnerClass
{
  public:
    ...
    InnerClass read(FILE*, AttributeInfo);
};
...
class Synthetic
{
  public:
    uint16_t name_index;
    uint32_t length;
    Synthetic read(FILE *, AttributeInfo);
};
...
class ConstantValue
{
  public:
    ...
    ConstantValue read(FILE *, AttributeInfo);
};
...
class AttributeInfo
{
  public:
    ...
    AttributeInfo get_attribute_info(FILE*, AttributeInfo);
    void read(FILE *);
